...
object AppConfig {
    ...
    const val PREF_APP_ACCENT_THEME = "pref_app_accent_theme"
    const val PREF_USE_CUSTOM_ACCENT = "pref_use_custom_accent"
    const val PREF_CUSTOM_ACCENT_COLOR = "pref_custom_accent_color"
    const val PREF_GAMING_ENABLED = "pref_gaming_enabled"
